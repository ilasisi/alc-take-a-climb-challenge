var Contacts = {
    ...
    $button_save: document.getElementById("save_button"),
    ...
    tableAdd: function(entry) {
        ...
        $td = document.createElement("td");
        $td.innerHTML = '<button style="margin-right:5px;padding: 4px 10px;font-weight: bold; color: #fff; border: 0px;background-color: green;cursor:pointer" data-op="edit" data-id="'+ entry.id +'">Edit</button><button style="padding: 4px 10px;font-weight: bold; color: #fff; border: 0px;background-color: #dc4444;cursor:pointer" data-op="remove" data-id="'+ entry.id +'">Remove</button>';
        $tr.appendChild($td);
